...
import {footerVariants,fadeIn2,fadeIn4,textVariant,planetVariants,dropIn,Rolling,Appear, fadeIn5,AppearMain} from '../utils/motion';
...
export default function AboutPage () {
  ...
  function expTab (ind){
    ...
    if(ind ===1){
      seiha.classList.add('bg-slate-800','text-emerald-400','border-emerald-400','border-l-2')
      Cseiha.classList.remove('invisible')
      rumo.classList.remove('bg-slate-800','text-emerald-400','border-emerald-400','border-l-2')
      Crumo.classList.add('invisible')
    }else if(ind ===2){
      seiha.classList.remove('bg-slate-800','text-emerald-400','border-emerald-400','border-l-2')
      Cseiha.classList.add('invisible')
      rumo.classList.add('bg-slate-800','text-emerald-400','border-emerald-400','border-l-2')
  ...
  return(
    <>
      <section className=' w-full min-h-screen px-56 py-20 '>
        <div className='flex justify-center  items-center border-red-500  box-border '
        >
          <div className=' border-red-200 h-[40rem] w-3/5 '>
            <div className=" font-bold text-4xl tracking-wide dark:text-neutral-200 indent-8 w-full  flex items-end justify-between">About Me <div className='border-t border-slate-400 dark:border-slate-600 w-4/6 h-5 '></div></div>
          ...
          <div className=' h-[40rem] w-2/5 box-border  flex justify-end items-center '>
            <motion.div className="w-5/6  box-border   "
              ...
              >
              <img  src='/main.jpg' className=" bg-transparent rounded-full h-full w-full border-transparent   " ></img>
            </motion.div>
            <div className='h-1/2 w-10  border-slate-400 dark:border-slate-600 border-r flex self-end'></div>
          </div>
        </div>
        <div className='h-screen flex pt-16'>
          <motion.div className='w-2/5 h-full mt-20  flex-col flex  items-center '
          variants={fadeIn5('up','spring',0.1,1)} initial='hidden' whileInView='show' viewport={{ once: true }}
          >
            <motion.div className="w-6/6  box-border  relative mt-10 mx-6"
            initial='hidden'  whileHover='hover'
              >
              <motion.img variants={AppearMain()} src='/Rumo.jpg' className=" bg-transparent rounded-full h-full w-full border-transparent z-50" ></motion.img>
              <motion.img variants={Appear()} src='/Seiha.jpg' className=" bg-transparent rounded-full h-full w-full border-transparent absolute " ></motion.img>
            </motion.div>
          </motion.div>
          <div className='w-3/5 h-full  border-slate-400 dark:border-slate-600'>
            <div className=" font-bold text-4xl tracking-wide dark:text-neutral-200  w-full  flex items-end justify-evenly"><div className='border-t border-slate-400 dark:border-slate-600 w-4/6 h-5 '></div>My Story </div>
            <motion.div 
            variants={textVariant(0.1)}  viewport={{once:true}} initial='hidden' whileInView='show'
            className='h-3/4 mt-16 border-r border-slate-400 dark:border-slate-600 text-justify'>
              <div className='h-2/4 mx-8  font-mono text-lg dark:text-slate-400 leading-8 indent-2  '> My first contact with coding was during my Transportation Engineering course back in 2010, learning  C++. 
              ...
              <div className='h-1/4 mx-8  font-mono text-lg dark:text-slate-400 leading-8 indent-2  '> 
        ...
        <div className=' h-[25rem] w-full'>
          <div className="font-bold text-4xl tracking-wide dark:text-neutral-200 indent-8 w-full  flex items-end justify-between">Education <div className='border-t border-slate-400 dark:border-slate-600 w-4/6 h-5 '></div></div>
          <div className='h-4/6 mt-16 border-l border-slate-400 dark:border-slate-600 text-justify flex justify-center'>
            <motion.div className=' w-4/5 border-slate-600 dark:text-slate-300 flex-col flex justify-evenly'
            variants={textVariant(0.1)}  viewport={{once:true}} initial='hidden' whileInView='show'
            >
              <div className=' p-4 space-y-3'>
                <div className='font-semibold text-2xl flex justify-between'>Web Development <div className='font-mono dark:text-slate-300 text-xl font-light'>May 2022 - May 2023</div> </div>
                <div className='font-medium text-xl'>Cornerstone</div>
              </div>
              <div className=' p-4 space-y-3'>
                <div className='font-semibold text-2xl flex justify-between'>Transportation Engineering <div className='font-mono dark:text-slate-300 text-xl font-light'>Mar 2010 - Aug 2016</div> </div>
                <div className='font-medium text-xl'>Federal University of Itajuba</div>
              </div>
            </motion.div>
          </div>
        </div>
        <div className=' h-[30rem] w-full'>
          <div className=" font-bold text-4xl tracking-wide dark:text-neutral-200  w-full  flex items-end justify-evenly"><div className='border-t border-slate-400 dark:border-slate-600 w-4/6 h-5 '></div>Experience </div>
          <motion.div className='h-4/6 mt-16 border-r border-slate-400 dark:border-slate-600 text-justify flex justify-center'
          variants={textVariant(0.1)}  viewport={{once:true}} initial='hidden' whileInView='show'
          >
            <div className='w-3/5  h-full flex relative' >
              <div className='w-1/6 border-l border-slate-600 h-1/2 flex flex-col items-center justify-center dark:text-slate-400 '>
                <div id='seiha' className='  border-l-2  w-full  h-16 flex justify-center items-center p-4 hover:cursor-pointer font-semibold text-2xl tracking-wider transition-all duration-200 ease-in-out ' onClick={()=>expTab(1)}>Seiha</div>
                <div id='rumo' className='  w-full  h-16 flex justify-center items-center p-4 hover:cursor-pointer font-semibold text-2xl tracking-wider  transition-all duration-200 ease-in-out ' onClick={()=>expTab(2)}>Rumo</div>
              </div>
                <div className=' w-5/6  flex justify-center'>
                  <div id='Cseiha' className='w-5/6 h-full '>
                  ...
                  <div id='Crumo' className='h-full w-5/6 absolute -right-12 invisible indent-3'>
                    ...
                    <ul className='text-base p-4  h-3/4 dark:text-slate-400  mt-4 list-disc list-inside marker:text-emerald-400 space-y-5 leading-7'>
        ...
        <div className='h-[30rem] flex flex-col  justify-evenly border-slate-400 dark:border-slate-600 mt-6'>
          <div className=" font-bold text-4xl tracking-wide dark:text-neutral-200  w-full  flex items-end justify-between"><div className='border-t border-slate-400 dark:border-slate-600 w-2/5 h-5 '/>My Tech-Stack<div className='border-t border-slate-400 dark:border-slate-600 w-2/5 h-5 '/></div>
          <div className='h-5/6  w-full flex pt-5  mt-4 '>
            <motion.div className='w-1/2  mx-2'
            variants={textVariant(0.1)}  viewport={{once:true}} initial='hidden' whileInView='show'
            >
              ...
              <div className='h-3/6 border-slate-400 dark:border-slate-600 border-r box-border flex-wrap flex justify-center gap-x-7 gap-y-7 '>
